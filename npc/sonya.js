...
const NPC_SONYA_QUEST = {
  ...
  q3: {
    ...
    item: 'sonyaCompass',
    intro: 'Кажется, я потеряла свой старый компас где-то у деревьев в правой части двора. Без него я чувствую себя странно…',
    hint: 'Старый компас лежит у деревьев в правой части двора, рядом с большими соснами. Поищи там!',
