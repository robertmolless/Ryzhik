...
const QUESTS = [
  ...
  { id:'q_notes', title:'Записки старого хозяина', icon:'📝', desc:'В доме есть записки прежнего хозяина.', steps:['Найди записку на чердаке','Найди записку в подвале','Найди записку в теплице'], reward:{xp:35,item:'letter'}, npc:null, unlock:false },
...
const NPC_DATA = [
  {
    ...
    dialogues:{
      morning:['Доброе утро, Рыжик! Покормить тебя?','Тихое утро... люблю такие.'],
      day:['Привет, рыжий! Как дела?','Тут тихо — мне нравится.','Знаешь, этот дом хранит много тайн...'],
      evening:['Эй, Рыжик. Посиди рядом.','Закат красивый сегодня...','Сыграю что-нибудь тихое на гитаре.'],
      night:['Не спишь? Я тоже.','Звёзды сегодня яркие.','Потерял кассету... не видел?']
    },
  ...
  },
  {
    ...
    dialogues:{
      morning:null,
      day:['Рыжик! Рок-мяу! 🤘','Репетирую новый трек в гараже.'],
      evening:['Сегодня мини-концерт на крыльце!','Потерял медиатор... вроде у пруда был.','Слышишь этот бит? Сверчки рокеры!'],
      night:['Ночные прогулки — самое то!','Слышишь? Сверчки играют! Это рок!']
    },
  ...
  },
  {
    ...
    dialogues:{
      morning:['Доброе утро! Рыжик, ты такой фотогеничный!','Снимаю утреннюю росу. Красота!'],
      day:['Смотри какие цветы! Сфоткаю!','Делаю альбом воспоминаний об этом месте.','Хочу сфоткать тебя рядом с цветами!'],
      evening:['Вечерний свет идеален для фото...','Мечтаю поймать светлячков на камеру.'],
      night:null
    },
  ...
  },
  {
    ...
    dialogues:{
      morning:['Утро! Пора украшать двор!','Рыжик, принёс наклейки? 😸'],
      day:['Рыжик! Смотри что я принесла!','Двор нужно украсить!','Потеряла свои наклейки везде...'],
      evening:['Вечеринка на дворе! Ты идёшь?','Твой уголок надо наклейками обклеить!'],
      night:null
    },
  ...
  },
  {
    ...
    dialogues:{
      ...
      evening:['Рыжик... Ты чувствуешь магию этого места?','Теплица хранит тайну. Найди колокольчик.','Легенда гласит — здесь живёт дух дома...'],
      night:['В темноте видно то, что скрыто днём.','Колокольчик луны зовёт... Слышишь?','Ищи, Рыжик. Ты близко к разгадке.']
    },
  ...
  },
  {
    ...
    trustLevels:['Незнакомец','Знакомый','Друг','Лучший друг'],
    schedule:{ morning:[800,550], day:[820,540], evening:[810,560], night:null },
    dialogues:{
      morning:['Рыжик! Иду в лес. Не отставай!','Знаю тут безопасную тропу через лес.'],
      day:['Тут красиво, правда?','Через лес выйдем на поляну.','Я знаю все тропы в округе!'],
      evening:['Вечерний лес — это особенная красота...','Закат сквозь деревья. Волшебно.'],
      night:null
    },
  ...
  },
  {
    ...
    dialogues:{
      morning:['Утро! Уже записываю наблюдения...','Рыжик, ты опять сделал что-то странное?'],
      day:['Рыжик, ты сделал это снова? Записываю!','Странные события тут каждый день...','Потеряла страницу из блокнота...'],
      evening:['Вечером тут происходит кое-что интересное...','Ты очень интересный кот, Рыжик.'],
      night:null
    },
  ...
  },
  {
    ...
    dialogues:{
      morning:['Утро. Уже вижу, что надо чинить...','Рыжик, не мешай, работаю.'],
      day:['Нужно починить забор...','Рыжик. Ты мне помогаешь? Стой тут.','Ищу деталь для фонарика. Не видел?'],
      evening:['Закончила ремонт. Двор стал лучше!','Фонарик почти готов...'],
      night:null
    },
  ...
  },
  {
    ...
    dialogues:{
      morning:null,
      day:['Рыжик! Смотри что я нашёл!','Из этого можно скрафтить кое-что...','Собираю штуки для коробки сокровищ!'],
      evening:['Смастерил тебе игрушку! Лови!','Рыжик, ты лучший! Держи штуку.'],
      night:null
    },
  ...
  },
  {
    ...
    dialogues:{
      morning:['Рыжик. Иди сюда. Буду чинить забор.','Доброе утро, кот. Работы много.'],
      day:['Хм. Неплохой кот.','Помоги — стой рядом, будешь надзирать.','Этот забор сам себя не починит.'],
      evening:['Устал. Но забор почти готов.','Хороший был день, кот.'],
      night:null
    },
...
class Game {
  ...
  _onQuestAdvance(qid) {
    ...
    if (result === 'complete') {
      ...
      if (doneCount >= 9) { this.quests.unlock('q_notes'); }
