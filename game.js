...
const ITEMS = {
  ...
  apple:    { id:'apple',    name:'Яблоко',         icon:'🍎', desc:'Сочное яблоко с огорода. Ёжик Пых обожает яблоки.', rare:false },
  feather:  { id:'feather',  name:'Перо',           icon:'🪶', desc:'Красивое перо. Ворона Каркуша потеряла его.', rare:false },
  ...
  ribbon:   { id:'ribbon',   name:'Ленточка',       icon:'🎀', desc:'Красивая ленточка. Настя может её подарить.', rare:false },
  bell:     { id:'bell',     name:'Колокольчик',    icon:'🔔', desc:'Тихо звенит на ветру. Очень уютный звук.', rare:true },
  mouseMap: { id:'mouseMap', name:'Карта мышонка',  icon:'🗺️', desc:'Мышонок Тим нарисовал карту своих ходов.', rare:true },
  glasses:  { id:'glasses',  name:'Очки бабушки',   icon:'👓', desc:'Бабушкины очки! Она их везде ищет.', rare:false },
  ...
  cassette: { id:'cassette', name:'Кассета Лёхи',   icon:'📼', desc:'Старая кассета с любимой музыкой Лёхи.', rare:false },
  pick:     { id:'pick',     name:'Медиатор',       icon:'🎸', desc:'Медиатор Игоря. Потерял у пруда.', rare:false },
  diary:    { id:'diary',    name:'Страница дневника',icon:'📄',desc:'Потерянная страница из дневника Нэны.', rare:false },
...
const QUESTS = [
  ...
  { id:'q02', title:'Очки бабушки Анны', icon:'👓', desc:'Бабушка Анна никак не найдёт свои очки. Помоги ей!', steps:['Поговори с бабушкой', 'Найди очки в саду', 'Верни бабушке'], reward:{item:'fish',xp:15}, npc:'anna', unlock:true },
  { id:'q03', title:'Подружиться с Бароном', icon:'🐕', desc:'Пёс Барон рычит на Рыжика. Нужно найти подход.', steps:['Подойди к Барону', 'Принеси ему угощение', 'Познакомься по-хорошему'], reward:{xp:20,trust:'baron'}, npc:'baron', unlock:true },
  { id:'q04', title:'Ключ от сарая', icon:'🗝️', desc:'В сарае что-то интересное, но он заперт. Найди ключ!', steps:['Поищи ключ во дворе', 'Проверь у колодца', 'Открой сарай'], reward:{item:'barnKey',xp:15,zone:'barn'}, npc:null, unlock:true },
  { id:'q05', title:'Яблоки для ёжика', icon:'🍎', desc:'Ёжик Пых очень хочет яблок. Собери их в саду!', steps:['Поговори с Пыхом', 'Собери 3 яблока в саду', 'Принеси Пыху'], reward:{item:'acorn',xp:12}, npc:'hedgehog', unlock:false },
  { id:'q06', title:'Перья для Каркуши', icon:'🪶', desc:'Ворона Каркуша растеряла свои красивые перья. Помоги найти!', steps:['Найди 2 пера по двору', 'Верни Каркуше'], reward:{item:'coin',xp:12}, npc:'crow', unlock:false },
  { id:'q07', title:'Поймать солнечный зайчик', icon:'🌟', desc:'На поляне видели необычный солнечный зайчик. Что это?', steps:['Выйди на поляну', 'Поймай зайчик (мини-игра)'], reward:{xp:18,item:'leaf'}, npc:null, unlock:false },
  { id:'q08', title:'Тайный проход', icon:'🔍', desc:'Рыжик чувствует — где-то есть тайный проход. Найди его!', steps:['Исследуй забор', 'Найди тайную тропу'], reward:{xp:20,zone:'secret_path'}, npc:null, unlock:false },
  { id:'q09', title:'Исследовать чердак', icon:'🪜', desc:'На чердаке давно никто не бывал. Там могут быть интересные вещи!', steps:['Найди лестницу', 'Поднимись на чердак', 'Осмотри чердак'], reward:{item:'letter',xp:25,zone:'attic'}, npc:null, unlock:false },
  { id:'q10', title:'Открыть подвал', icon:'🚪', desc:'Подвал закрыт. Что там скрывается?', steps:['Найди ключ от подвала', 'Открой подвал', 'Исследуй'], reward:{xp:25,item:'coin',zone:'cellar'}, npc:null, unlock:false },
  { id:'q11', title:'Карта мышонка', icon:'🗺️', desc:'Мышонок Тим потерял свою карту ходов. Помоги найти!', steps:['Поговори с Тимом', 'Найди карту в подвале', 'Верни Тиму'], reward:{item:'mouseMap',xp:15}, npc:'mouse', unlock:false },
  { id:'q12', title:'Котёнок Муси', icon:'🐱', desc:'Кошка Муся не может найти своего котёнка! Помоги!', steps:['Поговори с Мусей', 'Найди котёнка в сарае', 'Верни Мусе'], reward:{xp:20,item:'yarn'}, npc:'musia', unlock:false },
  { id:'q13', title:'Рыбалка у пруда', icon:'🎣', desc:'У пруда можно поймать вкусную рыбку!', steps:['Иди к пруду', 'Порыбачь (мини-игра)', 'Поймай рыбку'], reward:{item:'fish',xp:15}, npc:null, unlock:false },
  { id:'q14', title:'Разбудить почтальона', icon:'📬', desc:'Почтальон заснул у забора и не слышит звонка. Мяукни!', steps:['Найди почтальона', 'Громко мяукни рядом', 'Помоги с письмом'], reward:{item:'letter',xp:10}, npc:'postman', unlock:false },
  { id:'q15', title:'Починить кошачий уголок', icon:'🏠', desc:'Кошачий уголок Рыжика пришёл в запустение. Нужно починить!', steps:['Собери нужные материалы', 'Пригласи Кристину помочь', 'Обнови уголок'], reward:{xp:30,upgrade:'corner'}, npc:'kristina', unlock:false },
  { id:'q16', title:'Коллекция блестяшек', icon:'💎', desc:'Рыжик любит блестящие вещи. Собери 5 штук!', steps:['Найди 5 блестящих предметов'], reward:{xp:20,item:'ribbon'}, npc:null, unlock:false },
  { id:'q17', title:'Записки старого хозяина', icon:'📝', desc:'В доме есть старые записки прежнего хозяина. Найди их!', steps:['Найди записку на чердаке','Найди записку в подвале','Найди записку в теплице'], reward:{xp:35,item:'letter'}, npc:null, unlock:false },
  { id:'q18', title:'Открыть теплицу', icon:'🌿', desc:'Заброшенная теплица закрыта уже много лет. Как войти?', steps:['Найди ключ от теплицы','Расчисти вход','Войди в теплицу'], reward:{xp:40,zone:'greenhouse'}, npc:'mag', unlock:false },
  { id:'q19', title:'Странный колокольчик', icon:'🔔', desc:'Маг говорит о колокольчике с особой силой. Найди его ночью!', steps:['Поговори с Магом ночью','Найди колокольчик на поляне'], reward:{item:'bell',xp:25}, npc:'mag', unlock:false },
  { id:'q20', title:'Вечерний мяу-концерт', icon:'🎵', desc:'Рыжик хочет устроить концерт! Позови всех соседей.', steps:['Пригласи Лёху и Игоря','Выйди на крыльцо вечером','Мяукни 3 раза'], reward:{xp:25,event:'concert'}, npc:null, unlock:false },
  { id:'q21', title:'Праздник во дворе', icon:'🎉', desc:'Пора устроить праздник! Соберись со всеми жителями.', steps:['Выполни 10 квестов','Позови всех NPC','Устрой праздник'], reward:{xp:50,event:'party'}, npc:null, unlock:false },
  { id:'q22', title:'Найти светлячков', icon:'✨', desc:'Ночью в саду появились светлячки. Иди скорее смотреть!', steps:['Дождись ночи','Выйди в сад','Поймай светлячка (мини-игра)'], reward:{xp:20,item:'acorn'}, npc:null, unlock:false },
  { id:'q23', title:'Помочь уткам', icon:'🦆', desc:'Утки у пруда что-то ищут. Помоги им!', steps:['Подойди к уткам','Найди их потерянный предмет','Верни уткам'], reward:{xp:15,item:'feather'}, npc:'ducks', unlock:false },
  { id:'q24', title:'Тайна старой теплицы', icon:'🔮', desc:'Что скрывает заброшенная теплица? Разгадай тайну!', steps:['Войди в теплицу','Найди Солнечный колокольчик','Узнай историю дома'], reward:{item:'sunBell',xp:60}, npc:null, unlock:false },
  { id:'q25', title:'Финал: Вернуть уют дому', icon:'🏡', desc:'Рыжик почти всё сделал! Собери всех вместе и верни дому уют.', steps:['Завершить квесты 1-24','Собрать всех у дома вечером','Позвонить в Солнечный колокольчик'], reward:{xp:100,event:'finale'}, npc:null, unlock:false },
  // Human character quests
  { id:'qh01', title:'Старая кассета Лёхи', icon:'📼', desc:'Лёха потерял любимую кассету в сарае. Найди её!', steps:['Поговори с Лёхой','Поищи в сарае','Верни кассету'], reward:{item:'cassette',xp:18,trust:'lyokha'}, npc:'lyokha', unlock:false },
  { id:'qh02', title:'Пропавший медиатор', icon:'🎸', desc:'Игорь потерял медиатор у пруда. Помоги найти!', steps:['Поговори с Игорем','Найди медиатор у пруда'], reward:{item:'pick',xp:15,trust:'igor'}, npc:'igor', unlock:false },
  { id:'qh03', title:'Фото со светлячками', icon:'📷', desc:'Настя хочет ночную фотографию со светлячками. Помоги!', steps:['Поговори с Настей','Дождись ночи','Выйдите в сад вместе'], reward:{item:'ribbon',xp:20,trust:'nastya'}, npc:'nastya', unlock:false },
  { id:'qh04', title:'Потерянные наклейки Лизы', icon:'⭐', desc:'Лиза потеряла наклейки по всему двору. Собери 5!', steps:['Поговори с Лизой','Найди 5 наклеек'], reward:{xp:18,trust:'liza'}, npc:'liza', unlock:false },
  { id:'qh05', title:'Колокольчик луны', icon:'🌙', desc:'Маг ищет старый колокольчик. Найди его ночью!', steps:['Встреть Мага ночью','Найди колокольчик на поляне'], reward:{item:'bell',xp:25,trust:'mag'}, npc:'mag', unlock:false },
];
...
const ACHIEVEMENTS = [
  ...
  { id:'ach02', name:'Первый друг',          icon:'🤝', desc:'Подружись с первым NPC.', secret:false },
  ...
  { id:'ach05', name:'Любимец бабушки',      icon:'👵', desc:'Достигни макс. доверия с бабушкой Анной.', secret:false },
  { id:'ach06', name:'Друг Барона',          icon:'🐕', desc:'Подружись с псом Бароном.', secret:false },
  ...
  { id:'ach17', name:'Все NPC друзья',       icon:'👥', desc:'Подружись со всеми жителями.', secret:false },
...
const NPC_DATA = [
  {
    id:'anna', name:'Бабушка Анна', emoji:'👵', color:'#c8a060',
    x:350, y:300, zone:'porch',
    trustLevels:['Незнакомец','Знакомая','Хорошая знакомая','Любимица'],
    schedule:{ morning:[350,300], day:[400,280], evening:[350,300], night:null },
    dialogues:{
      morning:['Доброе утро, Рыжик! Пойдём завтракать?','Как ты спал, котик?'],
      day:['Ой, я снова потеряла очки...','Рыжик, ты не видел мои очки?'],
      evening:['Вечерний чай уже готов!','Присядь рядом, Рыжик.'],
      night:['Поздно уже, котик. Иди спать.','Ночью холодно, не гуляй долго.']
    },
    quest:'q02',
    actions: ['Поговорить', 'Погладить'],
    onPet: 'Мррр... Бабушка Анна почесала тебя за ухом! +5 настроения'
  },
  {
    id:'baron', name:'Пёс Барон', emoji:'🐕', color:'#8b6914',
    x:500, y:450, zone:'yard',
    trustLevels:['Рычит','Настороженный','Терпит','Друг'],
    schedule:{ morning:[520,440], day:[500,450], evening:[480,460], night:[510,420] },
    dialogues:{
      morning:['Гав! Чужой!','Р-р-р...'],
      day:['Гав-гав! Стой там!','Моя территория!'],
      evening:['Гав... Ладно, проходи.','Ты принёс что-нибудь вкусное?'],
      night:['Гав-гав! Кто ходит ночью?','Охраняю двор!']
    },
    quest:'q03',
    actions: ['Подойти', 'Угостить'],
    requiresTrust: 1
  },
  {
    id:'musia', name:'Кошка Муся', emoji:'🐈', color:'#d4a0c0',
    x:600, y:350, zone:'garden',
    trustLevels:['Шипит','Настороженная','Подруга','Лучшая подруга'],
    schedule:{ morning:[580,320], day:[620,360], evening:[600,350], night:[590,380] },
    dialogues:{
      morning:['Мяу! Я не видела котёнка с утра!','Рыжик, ты не видел малыша?'],
      day:['Мур-мур... Хороший день.','Ты уже завтракал?'],
      evening:['Мяу~ Так уютно вечером.','Ты мне нравишься, Рыжик.'],
      night:['Мур-мур... Тихо.','Ночью так красиво.']
    },
    quest:'q12',
    actions: ['Потереться носами', 'Поиграть']
  },
  {
    id:'hedgehog', name:'Ёжик Пых', emoji:'🦔', color:'#8b7355',
    x:700, y:500, zone:'garden',
    trustLevels:['Фырчит','Любопытный','Дружелюбный','Лучший друг'],
    schedule:{ morning:[680,480], day:null, evening:[700,500], night:[720,510] },
    dialogues:{
      morning:['Фыр! Иду за яблоками!','Рыжик! Как дела?'],
      day:null,
      evening:['Пых-пых... Ищу яблоки.','Принёс яблочки? Пых!'],
      night:['Пых... Пора спать.','Ночью ищу жуков. Вкусно!']
    },
    quest:'q05',
    actions: ['Угостить яблоком', 'Поговорить']
  },
  {
    id:'crow', name:'Ворона Каркуша', emoji:'🐦‍⬛', color:'#444444',
    x:800, y:200, zone:'yard',
    trustLevels:['Каркает','Наблюдает','Любопытная','Подруга'],
    schedule:{ morning:[800,200], day:[820,210], evening:[780,220], night:null },
    dialogues:{
      morning:['КАР! Каркуша видит всё!','КАР-КАР! Утром тихо.'],
      day:['Кар! Где мои перья?','Я всё видела, кот!'],
      evening:['Кар... Скоро спать.','Кар-кар! Красиво вечером.'],
      night:null
    },
    quest:'q06',
    actions: ['Поговорить', 'Вернуть перья']
  },
  {
    id:'mouse', name:'Мышонок Тим', emoji:'🐭', color:'#888888',
    x:450, y:550, zone:'cellar',
    trustLevels:['Убегает','Прячется','Выглядывает','Доверяет'],
    schedule:{ morning:null, day:[460,540], evening:[440,560], night:[450,555] },
    dialogues:{
      morning:null,
      day:['Пи-пи! Я потерял карту!','Пи! Не подходи!'],
      evening:['Пи-пи... Ты хороший кот.','Моя карта... где она?'],
      night:['Пи! Ночью я смелее.','Пи-пи... Нашёл что-нибудь?']
    },
    quest:'q11',
    actions: ['Тихо подойти', 'Дать еду']
  },
  {
    id:'postman', name:'Почтальон', emoji:'📮', color:'#4488cc',
    x:300, y:600, zone:'fence',
    trustLevels:['Спит','Просыпается','Знакомый','Приятель'],
    schedule:{ morning:[310,590], day:[300,600], evening:null, night:null },
    dialogues:{
      morning:['Zzz... мм...','Ой! Проспал! Письма!'],
      day:['Доброго дня! Есть письмо для дома.','Рыжик! Ты тут живёшь?'],
      evening:null,
      night:null
    },
    quest:'q14',
    actions: ['Мяукнуть рядом', 'Поговорить']
  },
  {
    id:'filimon', name:'Старый кот Филимон', emoji:'🐱', color:'#888866',
    x:900, y:400, zone:'secret_path',
    trustLevels:['Молчит','Смотрит','Говорит','Мудрый наставник'],
    schedule:{ morning:[880,420], day:null, evening:[900,400], night:[920,390] },
    dialogues:{
      morning:['Мур... Долгая жизнь учит терпению.','Молодой кот. Ищи.'],
      day:null,
      evening:['Я видел этот дом молодым...','Теплица хранит тайну. Ищи колокольчик.'],
      night:['Мур-мур... Ночью всё видно иначе.','Слушай тишину, Рыжик.']
    },
    quest:'q08',
    actions: ['Послушать', 'Сидеть рядом']
  },
  {
    id:'ducks', name:'Утки у пруда', emoji:'🦆', color:'#448833',
    x:1000, y:600, zone:'pond',
    trustLevels:['Улетают','Настороженные','Остаются','Друзья'],
    schedule:{ morning:[980,620], day:[1000,600], evening:[990,610], night:null },
    dialogues:{
      morning:['Кря! Кря-кря!','Кря! Доброе утро!'],
      day:['Кря-кря! Ищем хлеб.','Кря! Ты нам поможешь?'],
      evening:['Кря-кря... Тихий вечер.','Кря. Хорошо у пруда.'],
      night:null
    },
    quest:'q23',
    actions: ['Покормить', 'Поговорить']
  },
  // Human characters
  {
    ...
    schedule:{ morning:null, day:[360,290], evening:[340,310], night:[330,320] },
    dialogues:{
      morning:null,
      day:['Привет, рыжий! Как дела?','Тут тихо — мне нравится.'],
      evening:['Эй, Рыжик. Посиди рядом.','Закат красивый сегодня...','Сыграю что-нибудь тихое.'],
      night:['Не спишь? Я тоже.','Звёзды сегодня яркие.']
    },
    quest:'qh01', appearance:'👱 светлая кофта, спокойный взгляд',
    actions: ['Поговорить', 'Угоститься едой', 'Послушать гитару']
  },
  {
    id:'igor', name:'Игорь', emoji:'🤘', color:'#ff4444',
    x:550, y:600, zone:'yard', human:true,
    trustLevels:['Незнакомец','Знакомый','Друг','Лучший друг'],
    schedule:{ morning:null, day:null, evening:[550,600], night:[540,590] },
    dialogues:{
      morning:null, day:null,
      evening:['Рыжик! Слышишь рок-мяу? ГАВ-МЯУ!','Сегодня концерт на крыльце!','Потерял медиатор... у пруда был.'],
      night:['Ночные прогулки — самое то!','Слышишь? Сверчки играют!']
    },
    quest:'qh02', appearance:'🤘 чёрная куртка, цепочка',
  ...
  },
  {
    ...
    trustLevels:['Незнакомец','Знакомый','Друг','Лучший друг'],
    schedule:{ morning:[700,320], day:[720,310], evening:null, night:null },
    dialogues:{
      morning:['Доброе утро! Рыжик, ты такой фотогеничный!','Кормлю птичек. Присоединяйся!'],
      day:['Смотри какие цветы!','Хочу сфоткать тебя на рассвете!'],
      evening:null, night:null
    },
    quest:'qh03', appearance:'🌸 тёплая кофта, зелёные глаза',
  ...
  },
  {
    ...
    trustLevels:['Незнакомец','Знакомый','Друг','Лучший друг'],
    schedule:{ morning:null, day:[420,400], evening:[430,410], night:null },
    dialogues:{
      morning:null,
      day:['Рыжик! Смотри что я принесла!','Уберём двор вместе?','Потеряла свои наклейки везде...'],
      evening:['Вечеринка на дворе! Ты идёшь?','Твой уголок надо украсить!'],
      night:null
    },
    quest:'qh04', appearance:'💕 розовые волосы, яркая одежда',
    actions: ['Поговорить', 'Помочь с уборкой']
  },
  {
    ...
    dialogues:{
      morning:null, day:null,
      evening:['Рыжик... Ты чувствуешь магию этого места?','Теплица. Найди колокольчик.','Легенда гласит...'],
      night:['В темноте видно то, что скрыто днём.','Колокольчик луны зовёт...','Ищи, Рыжик. Ты близко.']
    },
    quest:'qh05', appearance:'🧙 шляпа, длинное пальто, амулеты',
    actions: ['Выслушать легенду', 'Спросить о теплице']
  },
  {
    id:'sonya', name:'Соня', emoji:'🎒', color:'#44aaff',
    x:800, y:550, zone:'forest_path', human:true,
    trustLevels:['Незнакомец','Знакомый','Друг','Лучший друг'],
    schedule:{ morning:[800,550], day:[820,540], evening:null, night:null },
    dialogues:{
      morning:['Рыжик! Иду в лес. Не отставай!','Знаю тут безопасную тропу.'],
      day:['Тут красиво, правда?','Через лес выйдем на поляну.'],
      evening:null, night:null
    },
    quest:null, appearance:'🎒 походная куртка, рюкзак',
  ...
  },
  {
    ...
    trustLevels:['Незнакомец','Знакомый','Друг','Лучший друг'],
    schedule:{ morning:null, day:[650,420], evening:[640,430], night:null },
    dialogues:{
      morning:null,
      day:['Рыжик, ты сделал это снова? Записываю!','Странные события тут каждый день...'],
      evening:['Потеряла страницу дневника...','Ты очень интересный кот, Рыжик.'],
      night:null
    },
    quest:'q17', appearance:'📓 очки, блокнот, свободная одежда',
  ...
  },
  {
    ...
    trustLevels:['Незнакомец','Знакомый','Друг','Лучший друг'],
    schedule:{ morning:null, day:[480,460], evening:null, night:null },
    dialogues:{
      morning:null,
      day:['Нужно починить забор...','Рыжик. Ты мне помогаешь?','Ищу детали для фонарика.'],
      evening:null, night:null
    },
    quest:'q15', appearance:'🔧 тёмная одежда, татуировки',
  ...
  },
  {
    ...
    dialogues:{
      morning:null,
      day:['Рыжик! Смотри что я нашёл!','Из этого можно сделать кое-что...','Потерял детали везде, кажется.'],
      evening:['Смастерил тебе игрушку! Лови!','Рыжик, ты лучший!'],
      night:null
    },
    quest:'q09', appearance:'🕶️ красные очки, шапка, худи',
  ...
  },
  {
    ...
    schedule:{ morning:[300,500], day:[310,490], evening:null, night:null },
    dialogues:{
      morning:['Рыжик. Иди сюда. Буду чинить забор.','Доброе утро, кот.'],
      day:['Хм. Неплохой кот.','Помоги — стой рядом, будешь надзирать.'],
      evening:null, night:null
    },
    quest:'q10', appearance:'💪 усы, татуированные руки, крупный',
...
const RANDOM_EVENTS = [
  ...
  { id:'box',      text:'Появилась новая коробка!',      icon:'📦', effect:{ mood:5, item:'box' } },
  { id:'crow_gift',text:'Каркуша принесла подарок!',    icon:'🐦‍⬛', effect:{ item:'coin' } },
  { id:'baron_bone',text:'Барон спрятал косточку',      icon:'🦴', effect:{} },
  { id:'pie',      text:'Бабушка испекла пирог! Вкусно!',icon:'🥧', effect:{ food:20, mood:10 } },
  { id:'ducks',    text:'Утки прилетели на пруд!',      icon:'🦆', effect:{ mood:5 } },
...
class World {
  ...
  _spawnCollectibles() {
    const items = [
      { x:350, y:380, item:'glasses', id:'c01' },
      { x:620, y:300, item:'apple',   id:'c02' },
      { x:640, y:280, item:'apple',   id:'c03' },
      { x:580, y:320, item:'apple',   id:'c04' },
      { x:160, y:370, item:'barnKey', id:'c05' },
      { x:820, y:200, item:'feather', id:'c06' },
      { x:790, y:210, item:'feather', id:'c07' },
...
class QuestSystem {
  constructor() {
    this.active    = new Set(['q01','q02','q03','q04']); // стартовые
...
class Game {
  ...
  _update(dt) {
    ...
    if (this.input.consumeMeow()) {
      ...
      // Wake postman
      const postman = this.npcs.find(n => n.id === 'postman');
      if (postman && postman.distTo(this.player.x, this.player.y) < 80) {
        this.quests.advanceStep('q14');
        this.ui.notify('📬 Почтальон проснулся!');
      }
    }
  ...
  _handleInteraction() {
    ...
    // Special locations
    if (this.player.x > 650 && this.player.x < 780 && this.player.y > 450 && this.player.y < 550) {
      // Pond — fishing
      if (this.quests.isActive('q13')) {
        this.miniGame.start('fishing', this);
        this.quests.advanceStep('q13');
        return;
      }
    }
  ...
  _onQuestAdvance(qid) {
    ...
    if (result === 'complete') {
      ...
      if (doneCount >= 3)  this.quests.unlock('q05');
      if (doneCount >= 4)  this.quests.unlock('q06');
      if (doneCount >= 5)  this.quests.unlock('q07');
      if (doneCount >= 6)  this.quests.unlock('q08');
      if (doneCount >= 7)  this.quests.unlock('q09');
      if (doneCount >= 8)  this.quests.unlock('q10');
      if (doneCount >= 9)  this.quests.unlock('q11');
      if (doneCount >= 10) { this.quests.unlock('q12'); this.quests.unlock('q13'); this.achievements.unlock('ach09'); }
      if (doneCount >= 12) this.quests.unlock('q14');
      if (doneCount >= 14) { this.quests.unlock('q15'); this.quests.unlock('q16'); }
      if (doneCount >= 16) { this.quests.unlock('q17'); this.quests.unlock('q18'); }
      if (doneCount >= 18) { this.quests.unlock('q19'); this.quests.unlock('q20'); }
      if (doneCount >= 20) { this.quests.unlock('q21'); this.quests.unlock('q22'); this.quests.unlock('q23'); }
      if (doneCount >= 23) this.quests.unlock('q24');
      if (doneCount >= 24) this.quests.unlock('q25');
      // Human quests
      if (doneCount >= 5)  { this.quests.unlock('qh01'); this.quests.unlock('qh02'); }
      if (doneCount >= 8)  { this.quests.unlock('qh03'); this.quests.unlock('qh04'); }
      if (doneCount >= 12) this.quests.unlock('qh05');
  ...
  _checkQuestItem(itemId) {
    // Auto-advance relevant quests
    const checks = {
      'glasses': 'q02', 'barnKey': 'q04', 'feather': 'q06',
      'letter': 'q17', 'cassette': 'qh01', 'pick': 'qh02',
      'diary': 'qh05', 'flashPart': 'q15', 'sticker': 'qh04',
      'sunBell': 'q24', 'mouseMap': 'q11', 'bell': 'q19',
    };
    ...
    if (itemId === 'sticker') {
      ...
      if (cnt >= 5 && this.quests.isActive('qh04')) {
        this._onQuestAdvance('qh04');
      }
    }
    // Bliny collection (pebble/coin/bell/leaf/button = shiny things)
    const shiny = ['coin','pebble','bell','leaf','button','acorn','ribbon'];
    if (shiny.includes(itemId)) {
      const total = shiny.reduce((s,i) => s + this.inventory.count(i), 0);
      if (total >= 5 && this.quests.isActive('q16')) { this._onQuestAdvance('q16'); }
  ...
  _checkAchievements() {
    ...
    if (this.unlockedZones.length >= 15) this.achievements.unlock('ach18');
    if (this.quests.completed.size >= 25) this.achievements.unlock('ach19');
    if (this.player.glory >= 200) this.achievements.unlock('ach20');
    const baron = this.npcs.find(n=>n.id==='baron');
    if (baron && baron.trust >= 3) this.achievements.unlock('ach06');
    const anna = this.npcs.find(n=>n.id==='anna');
    if (anna && anna.trust >= 3) this.achievements.unlock('ach05');
